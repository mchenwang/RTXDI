...
void main(uint3 GlobalIndex : SV_DispatchThreadID)
{
    ...
    // uint sampleCnt = min(WORLD_SPACE_LIGHT_SAMPLES_PER_GRID_MAX_NUM, u_WorldSpaceGridStatsBuffer[GlobalIndex.x].sampleCnt);
    // uint sampleCnt = WORLD_SPACE_LIGHT_SAMPLES_PER_GRID_MAX_NUM;
    uint sampleCnt = u_WorldSpaceGridStatsBuffer[GlobalIndex.x].sampleCnt;
