...
#define VIS_MODE_WS_GRID             15
#define VIS_MODE_ENV_VIS_DEBUG_1     16
#define VIS_MODE_ENV_VIS_DEBUG_2     17
...
struct WSRVisualizationConstants
{
    PlanarViewConstants view;
...
#define WORLD_SPACE_RESERVOIR_SOURCE_COMBINE     (1 << 8)
